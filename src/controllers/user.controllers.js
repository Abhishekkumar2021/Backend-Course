...
const register = TryCatchHandler(async (req, res) => {
    ...
    // verify the fields
    if(!email || !password || !username || !fullname) throw new APIError(400, "Missing required fields")
    ...
    const apiResponse = new APIResponse(200, "User registered successfully", { user: createdUser })
...
const refreshAccessToken = TryCatchHandler(async (req, res) => {
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "Access token refreshed successfully", { accessToken })
    apiResponse.send(res)
})
...
const changePassword = TryCatchHandler(async (req, res) => {
    ...
    // Verify the fields
    if(!oldPassword || !newPassword) throw new APIError(400, "Missing required fields")
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "Password changed successfully", {})
    apiResponse.send(res)
})
...
const getCurrentUser = TryCatchHandler(async (req, res) => {
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "User details fetched successfully", { user })
    apiResponse.send(res)
})
...
const updateProfile = TryCatchHandler(async (req, res) => {
    ...
    // Verify the fields
    if(!email && !username && !fullname) throw new APIError(400, "Missing required fields")
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "Profile updated successfully", { user })
    apiResponse.send(res)
})
...
const updateAvatar = TryCatchHandler(async (req, res) => {
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "Avatar updated successfully", { user })
    apiResponse.send(res)
})
...
const updateCoverImage = TryCatchHandler(async (req, res) => {
    ...
    // Send the response
    const apiResponse = new APIResponse(200, "Cover image updated successfully", { user })
    apiResponse.send(res)
})
